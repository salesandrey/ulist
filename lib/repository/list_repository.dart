...
class ListRepository {
  ...
  Future<void> add(String name,String description,String email) async {
    ...
    try {
      ...
      await listRef.add(ListModel(description: description, name: name,createdAt: Timestamp.now()));
